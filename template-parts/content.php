 ...
 */
$social_permalink = rawurlencode( get_permalink() ); // Get encoded post URL.
$post_title = get_the_title(); // Get post title.
$facebook_share = 'https://www.facebook.com/sharer/sharer.php?u='.$social_permalink;
$twitter_share = 'https://twitter.com/intent/tweet?text='.$post_title.'&amp;url='.$social_permalink.'&amp;via=GamingTalker';
$whatsapp_share = 'https://api.whatsapp.com/send?text='.$post_title.' - '.$social_permalink;
$telegram_share = 'https://telegram.me/share/url?url='.$social_permalink.'&text='.$post_title;
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'shinka-post__main' ); ?>>
	...
	<div class="shinka-post__heading">
		...
		<div class="shinka-post__share">
			<a href="#" class="shinka-post__sns-btn shinka-post__sns-btn-facebook">
			...
			<a href="#" class="shinka-post__sns-btn shinka-post__sns-btn-twitter">
			...
			<a href="#" class="shinka-post__sns-btn shinka-post__sns-btn-whatsapp">
			...
			<a href="#" class="shinka-post__sns-btn shinka-post__sns-btn-telegram">
