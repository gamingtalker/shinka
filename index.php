...
<div id="main-content" class="shinka-page">
    <div class="shinka-wrapper">
        <?php 
            get_template_part( 'template-parts/home/main-posts' );
            get_template_part( 'template-parts/home/sec-main-posts' ); 
        ?>
        ...
        <?php 
            ...
            get_template_part( 'template-parts/home/video-timeline' ); 
            get_template_part( 
